...
import com.axis.batch197.model.KecamatanModel;
import com.axis.batch197.model.KelurahanModel;
import com.axis.batch197.repository.KecamatanRepo;
import com.axis.batch197.repository.KelurahanRepo;
...
public class KelurahanController {
	...
	public ModelAndView list() {
		...
		List<KelurahanModel> listKelurahan = repo.findAll(Sort.by("kdKelurahan"));
	...
	public ModelAndView list(@PathVariable("key") String key) {
		...
		ModelAndView view = new ModelAndView("kelurahan/list");
		// load data kelurahan via repo, disimpan kedalam list
		List<KelurahanModel> listkelurahan = repo.search(key);
