...
public class XKeahlianModel {
	...
	//relasi dengan xbiodata
	@ManyToOne 
	@JoinColumn(name="biodata_id", foreignKey=@ForeignKey(name="fk_keahlian_bio"), updatable=false, insertable=false)
	private XBiodataModel keahlian;
	
	public XBiodataModel getKeahlian() {
		return keahlian;
	}

	public void setKeahlian(XBiodataModel keahlian) {
	...
	//relasi dengan xskilllevel
	@ManyToOne 
	@JoinColumn(name="skill_level_id", foreignKey=@ForeignKey(name="fk_skill_keahlian"), updatable=false, insertable=false)
	private XSkillLevelModel skill;
	
	public XSkillLevelModel getSkill() {
		return skill;
	}

	public void setSkill(XSkillLevelModel skill) {
		this.skill = skill;
	}
