...
public class XRiwayatPelatihanModel {
	...
	@ManyToOne 
	@JoinColumn(name="biodata_id", foreignKey=@ForeignKey(name="fk_pelat_bio"), updatable=false, insertable=false)
	private XBiodataModel pelatihan;
	
	public XBiodataModel getPelatihan() {
		return pelatihan;
	}

	public void setPelatihan(XBiodataModel pelatihan) {
