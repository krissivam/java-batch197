...
public class XBiodataAttachmentModel {
	...
	@TableGenerator(name="x_biodata_attachment_idx", table="tbl_index", pkColumnName="index_id", valueColumnName="index_value", initialValue=0, allocationSize=1)
	...
	@ManyToOne 
	@JoinColumn(name="biodata_id", foreignKey=@ForeignKey(name="fk_bioa_bio"), updatable=false, insertable=false)
	private XBiodataModel biodataA;
