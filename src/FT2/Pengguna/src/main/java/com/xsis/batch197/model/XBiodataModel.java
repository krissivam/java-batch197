...
public class XBiodataModel {
	...
	//relasi tabel dengan xriwayatpendidikan
	@OneToMany(mappedBy="biodata")
	private List<XRiwayatPendidikanModel> listPend = new ArrayList<XRiwayatPendidikanModel>();

	public List<XRiwayatPendidikanModel> getListPend() {
		return listPend;
	}

	public void setListPend(List<XRiwayatPendidikanModel> listPend) {
		this.listPend = listPend;
	}
	
	//relasi dengan xsertifikasi
	@OneToMany(mappedBy="sertifikasi")
	private List<XSertifikasiModel> listSer = new ArrayList<XSertifikasiModel>(); 

	public List<XSertifikasiModel> getListSer() {
		return listSer;
	}

	public void setListSer(List<XSertifikasiModel> listSer) {
		this.listSer = listSer;
	}

	//relasi dengan xriwayatpekerjaan 
	@OneToMany(mappedBy="pekerjaan")
	private List<XRiwayatPekerjaanModel> listPek = new ArrayList<XRiwayatPekerjaanModel>();
	
	public List<XRiwayatPekerjaanModel> getListPek() {
		return listPek;
	}

	public void setListPek(List<XRiwayatPekerjaanModel> listPek) {
		this.listPek = listPek;
	}

	//relasi dengan xriwayatpelatihan
	@OneToMany(mappedBy="pelatihan")
	private List<XRiwayatPelatihanModel> listPel = new ArrayList<XRiwayatPelatihanModel>();
	
	
	public List<XRiwayatPelatihanModel> getListPel() {
		return listPel;
	}

	public void setListPel(List<XRiwayatPelatihanModel> listPel) {
		this.listPel = listPel;
	}

	//relasi dengan xkeahlian
	@OneToMany(mappedBy="keahlian")
	...
	//relasi dengan xbiodata attachemnt
	@OneToMany(mappedBy="biodataA")
	private List<XBiodataAttachmentModel> listBioatt = new ArrayList<XBiodataAttachmentModel>(); 	
	
	public List<XBiodataAttachmentModel> getListBioatt() {
		return listBioatt;
	}

	public void setListBioatt(List<XBiodataAttachmentModel> listBioatt) {
		this.listBioatt = listBioatt;
	}
