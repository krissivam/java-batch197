...
public class XSertifikasiModel {
	...
	@ManyToOne 
	@JoinColumn(name="biodata_id", foreignKey=@ForeignKey(name="fk_ser_bio"), updatable=false, insertable=false)
	private XBiodataModel sertifikasi;
	
	
	public XBiodataModel getSertifikasi() {
		return sertifikasi;
	}

	public void setSertifikasi(XBiodataModel sertifikasi) {
