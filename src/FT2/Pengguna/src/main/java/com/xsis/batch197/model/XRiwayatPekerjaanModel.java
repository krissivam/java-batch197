...
public class XRiwayatPekerjaanModel {
	...
	@ManyToOne 
	@JoinColumn(name="biodata_id", foreignKey=@ForeignKey(name="fk_peker_bio"), updatable=false, insertable=false)
	private XBiodataModel pekerjaan;
	
	public XBiodataModel getPekerjaan() {
		return pekerjaan;
	}

	public void setPekerjaan(XBiodataModel pekerjaan) {
