...
public class XVacancySourceModel {
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "x_vacancy_source_idx")
	@TableGenerator(name = "x_vacancy_source_idx", table = "tbl_index", pkColumnName = "index_id", valueColumnName = "index_value", initialValue = 0, allocationSize = 1)
