...
public class XFamilyTreeTypeModel {
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "x_family_tree_type_idx")
	@TableGenerator(name = "x_family_tree_type_idx", table = "tbl_index", pkColumnName = "index_id", valueColumnName = "index_value", initialValue = 0, allocationSize = 1)
