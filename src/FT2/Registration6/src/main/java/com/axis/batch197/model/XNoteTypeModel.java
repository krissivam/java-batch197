...
public class XNoteTypeModel {
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "x_note_type_idx")
	@TableGenerator(name="x_note_type_idx", table = "tbl_index", pkColumnName = "index_id", valueColumnName = "index_value", initialValue = 0, allocationSize = 1)
	@Column(name="id")
	private Long id;
