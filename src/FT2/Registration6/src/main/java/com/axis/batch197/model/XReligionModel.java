...
public class XReligionModel {
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "x_religion_idx")
	@TableGenerator(name = "x_religion_idx", table = "tbl_index", pkColumnName = "index_id", valueColumnName = "index_value", initialValue = 0, allocationSize = 1)
